...
export interface ApiErrorError extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    error_id: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    orientation_check: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMachineMachine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    errors: Schema.Attribute.Relation<'manyToMany', 'api::error.error'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::machine.machine'
    > &
      Schema.Attribute.Private;
    machine_type: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 22;
      }>;
    publishedAt: Schema.Attribute.DateTime;
